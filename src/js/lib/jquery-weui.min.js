 ...
 * Licensed under the MIT license */
    ...
    t.modal = function (n, i) {
        ...
        var a = n.buttons, r = a.map(function (t, e) {
            ...
            o = '<div class="weui-dialog"><div class="weui-dialog__hd"><span class="success-icon"></span><strong class="weui-dialog__title">' + n.title + "</strong></div>" + (n.text ? '<div class="weui-dialog__bd">' + n.text + "</div>" : "") + '<div class="weui-dialog__ft">' + r + "</div></div>",
            s = t.openModal(o, i);
