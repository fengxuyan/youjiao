...
if(undefined != params.result_icon){
    var tpl = '<div class="weui-dialog">' +
        '<div class="weui-dialog__hd" style="display: flex;align-items: center;justify-content: center;"><span class="result-icon"  style="display: inline-block;padding-right: .13rem;width: .67rem;height: .67rem;color: #333;font-size: .4rem;background-size: .67rem .67rem;background-repeat: no-repeat;background-image:' + params.result_icon + '"></span><span class="weui-dialog__title">' + params.title + '</span></div>' +
        ( params.text ? '<div class="weui-dialog__bd">' + params.text + '</div>' : '') +
        '<div class="weui-dialog__ft">' + buttonsHtml + '</div>' +
        '</div>';
}else {
    var tpl = '<div class="weui-dialog">' +
        '<div class="weui-dialog__hd" style="display: flex;align-items: center;justify-content: center;"><span class="weui-dialog__title">' + params.title + '</span></div>' +
        ( params.text ? '<div class="weui-dialog__bd">' + params.text + '</div>' : '') +
        '<div class="weui-dialog__ft">' + buttonsHtml + '</div>' +
        '</div>';
}
